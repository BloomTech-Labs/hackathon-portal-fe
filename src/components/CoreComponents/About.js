      ...
      <div className="hero-background">
        <div className="hero-content">
          ...
          <div className="hero-right">
            ...
            <p>
              Hackathon Portal is the hub for everything hackathon. Whether you
              are coordinating a hackathon, judging aproject, or participating,
              Hakathon Portal is the best wayu to stay up to date on the event's
              actvity
            </p>
      ...
      <div className="bottom">
        <div className="bottom-content">
          <div className="bottom-left">
            <h2>
              Fostering creativity and innovationeam definiebas reformidans,
              exerci persecuti
            </h2>
