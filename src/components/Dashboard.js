         ...
         <div className="eventsList">
            <div className="event">
               <SvgIcon
                  ...
                  style={{ fontSize: 300 }}
               ></SvgIcon>
               <div className="eventName" id="createEventButtonText">
                  Create Event
               </div>
            </div>
