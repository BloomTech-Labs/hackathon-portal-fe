...
// This component is not being used in the current application. We combined it on to the HackathonList page.
    ...
    <div className={classes.fullList}>
      ...
      <container class="hackathon-list-header">
        <div className="hackathon-buttons">
          <Button
            id="view-archive-btn"
            onClick={() => props.history.push("/hackathons")}
          >
